...
We already met `ts_window`, which can be used to limit the time span of a
...
And it also can be used with [tibbletime](https://cran.r-project.org/web/packages/tibbletime/index.html) and [tsibble](https://cran.r-project.org/web/packages/tsibble/index.html).
