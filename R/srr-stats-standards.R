...
#'   Open: List columns are great to store time series.
#'   Add: ts_nest, ts_unnest, once nested, it is is like a new ts-boxable class (works for data.table, tibble, and data.frame)
